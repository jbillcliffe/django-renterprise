...
urlpatterns = [
    ...
    path('<uuid:customer_token>/',
         views.customer_view,
         name='customer_view'),
    path('<uuid:customer_token>/status_change/<int:status>',
         views.customer_status_change,
         name='customer_status_change'),
    path('<uuid:customer_token>/customer_notes_list/',
         views.CustomerNotesList.as_view(),
         name='customer_notes_list'),
    path('<uuid:customer_token>/customer_notes_list/<int:id>/',
         views.customer_view_notes,
         name='customer_view_notes'),
    path('<uuid:customer_token>/customer_notes_list/create/',
         views.customer_add_notes,
         name='customer_add_notes'),
    ...
    path('<uuid:customer_token>/orders/<int:order_id>/'
         'order_notes_list/',
         views.OrderNotesList.as_view(),
         name='order_notes_list'),
    path('<uuid:customer_token>/orders/<int:order_id>/'
         'order_notes_list/<int:id>',
         views.order_view_notes,
         name='order_view_notes'),
    path('<uuid:customer_token>/orders/<int:order_id>/'
         'order_notes_list/create/',
         views.add_order_notes,
         name='add_order_notes'),
    path('<uuid:customer_token>/orders/<int:order_id>/'
         'invoice_status/<int:invoice_id>/<str:set_invoice>',
         views.invoice_status_change,
         name='invoice_status_change'),
    path('<uuid:customer_token>/orders/<int:order_id>/'
         'invoice_create/<str:amount_paid>/<str:note>/',
