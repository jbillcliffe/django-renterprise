...
class OrderForm(forms.ModelForm):
    ...
    full_item_list = Item.objects.values("item_type", "item_serial", "status", 
        delivery_date_str = Cast('delivery_date', TextField()),
        collect_date_str = Cast('collect_date', TextField()),
        repair_date_str = Cast('repair_date', TextField()))
